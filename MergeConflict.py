...
print("Hello world, my name is Brady and my favorite programming language is C++");
print("Hello world, my name is Connor and my favorite programming language is Java ");
